...
<<#_comandos_para_zx-uno,Más adelante>> se explica lo que hace cada uno de ellos.
...
[TIP]
====
En el caso de tener en la tarjeta SD instalado <<esxdos,esxdos>>, el archivo `esxmmc.rom` debe ser la ROM con el mismo número de versión.
====
